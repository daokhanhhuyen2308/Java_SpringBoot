package com.codevui.user_management.exception;
...
//cứ có Exception thì nó giao cho thằng này xử lý
@RestControllerAdvice
public class HandleException{
    //cái này nó sẽ định nghĩa là cái method này sẽ xử lý cho cái Exception nào
